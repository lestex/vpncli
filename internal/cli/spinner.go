...
type spinner struct {
	...
	// message does not change once the spinner is started. Work that goes
	// through several named steps wants the checklist instead, which shows
	// them all rather than replacing one line with the next.
	message string
